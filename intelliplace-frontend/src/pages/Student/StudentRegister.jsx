                  ...
                  {[
                    ...
                    return (
                      <motion.div
                        ...
                        className="flex items-start space-x-4 p-5 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-blue-500/30 transition-all duration-300"
                      >
              ...
              <div className="relative">
                ...
                <div className="relative bg-gray-800/60 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/10">
                  ...
                  <div className="text-center mb-8">
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-blue-600 to-cyan-600 p-3 rounded-2xl border border-blue-400/30 shadow-lg">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="block w-full pl-10 pr-4 py-3 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 text-sm"
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="block w-full pl-10 pr-12 py-3 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 text-sm"
                    ...
                    >
                      <h4 className="text-sm font-medium text-gray-200 mb-3">Password Requirements</h4>
                    ...
                    <motion.button
                      ...
                      className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-4 px-6 rounded-xl font-semibold shadow-lg hover:shadow-blue-500/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3 text-sm"
                    >
                      {loading ? (
                        <>
